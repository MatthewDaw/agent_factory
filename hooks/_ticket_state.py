...
def resolve_validation_requirements(ticket: Any, project: str = "",
    ...
    TODO(semantic): a third lane — semantic match of the requirement predicate against the ticket's
    text — is a documented hook. Tag+surface is the v1 per-ticket contract.
    """
    ...
    if scope == "planning":
        out: dict[str, dict] = {}
        for chk in _praxis.facts_by(category=CHECK_CATEGORY):
