...
## Step 1 — Choose rigor mode

Ask the human once (blocking, single question) how hard to push:
...
Note in the doc which mode ran, so a quick pass never poses as an exhausted one.
